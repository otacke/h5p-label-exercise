...
export default class FocusTrap {
   ...
   * @param {boolean} [params.returnFocus] Whether to return focus to previous element on deactivate.
   * @param {HTMLElement} [params.returnFocusTo] Element to return focus to on deactivate.
   */
  constructor(params = {}) {
  ...
  async activate() {
    ...
    this.elementWithPreviousFocus = document.activeElement;

    this.isActivated = true;

    this.observer = await callOnceVisible(
  ...
  deactivate() {
    ...
    if (!this.params.returnFocus) {
      return;
    }

    (this.params.returnFocusTo ?? this.elementWithPreviousFocus).focus();
  }
